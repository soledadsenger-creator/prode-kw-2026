...
const LOGROS_LABELS = {
  captacion_simple: "Captacion simple", captacion_exclusiva: "Captacion exclusiva",
  ...
  capacitacion: "Capacitacion en oficina", plan_411: "Plan 411",
...
const FLAGS = {
  "Mexico":"\u{1F1F2}\u{1F1FD}","Sudafrica":"\u{1F1FF}\u{1F1E6}","Corea del Sur":"\u{1F1F0}\u{1F1F7}","Chequia":"\u{1F1E8}\u{1F1FF}",
  "Canada":"\u{1F1E8}\u{1F1E6}","Suiza":"\u{1F1E8}\u{1F1ED}","Qatar":"\u{1F1F6}\u{1F1E6}","Bosnia y Herzegovina":"\u{1F1E7}\u{1F1E6}",
  "Brasil":"\u{1F1E7}\u{1F1F7}","Marruecos":"\u{1F1F2}\u{1F1E6}","Haiti":"\u{1F1ED}\u{1F1F9}","Escocia":"\uD83C\uDFF4",
  "Estados Unidos":"\u{1F1FA}\u{1F1F8}","Paraguay":"\u{1F1F5}\u{1F1FE}","Australia":"\u{1F1E6}\u{1F1FA}","Turquia":"\u{1F1F9}\u{1F1F7}",
  "Alemania":"\u{1F1E9}\u{1F1EA}","Curazao":"\u{1F1E8}\u{1F1FC}","Costa de Marfil":"\u{1F1E8}\u{1F1EE}","Ecuador":"\u{1F1EA}\u{1F1E8}",
  "Paises Bajos":"\u{1F1F3}\u{1F1F1}","Japon":"\u{1F1EF}\u{1F1F5}","Tunez":"\u{1F1F9}\u{1F1F3}","Suecia":"\u{1F1F8}\u{1F1EA}",
  "Belgica":"\u{1F1E7}\u{1F1EA}","Egipto":"\u{1F1EA}\u{1F1EC}","Iran":"\u{1F1EE}\u{1F1F7}","Nueva Zelanda":"\u{1F1F3}\u{1F1FF}",
  "Espana":"\u{1F1EA}\u{1F1F8}","Cabo Verde":"\u{1F1E8}\u{1F1FB}","Arabia Saudita":"\u{1F1F8}\u{1F1E6}","Uruguay":"\u{1F1FA}\u{1F1FE}",
  "Francia":"\u{1F1EB}\u{1F1F7}","Senegal":"\u{1F1F8}\u{1F1F3}","Noruega":"\u{1F1F3}\u{1F1F4}","Irak":"\u{1F1EE}\u{1F1F6}",
  "Argentina":"\u{1F1E6}\u{1F1F7}","Argelia":"\u{1F1E9}\u{1F1FF}","Austria":"\u{1F1E6}\u{1F1F9}","Jordania":"\u{1F1EF}\u{1F1F4}",
  "Portugal":"\u{1F1F5}\u{1F1F9}","Colombia":"\u{1F1E8}\u{1F1F4}","Uzbekistan":"\u{1F1FA}\u{1F1FF}","R.D. Congo":"\u{1F1E8}\u{1F1E9}",
  "Inglaterra":"\uD83C\uDFF4","Croacia":"\u{1F1ED}\u{1F1F7}","Ghana":"\u{1F1EC}\u{1F1ED}","Panama":"\u{1F1F5}\u{1F1E6}",
};
...
const KNOCKOUT_PHASES = ["Dieciseisavos de Final","Octavos de Final","Cuartos de Final","Semifinal","3er y 4to Puesto","Final"];

function generateMatches() {
  const m = [];
  const grupos = [
    { id:1, group:"Grupo A", home:"Mexico", away:"Sudafrica", date:"Jue 11/06", time:"16:00" },
    { id:2, group:"Grupo A", home:"Corea del Sur", away:"Chequia", date:"Jue 11/06", time:"23:00" },
    { id:3, group:"Grupo B", home:"Canada", away:"Bosnia y Herzegovina", date:"Vie 12/06", time:"16:00" },
    { id:4, group:"Grupo D", home:"Estados Unidos", away:"Paraguay", date:"Vie 12/06", time:"22:00" },
    { id:5, group:"Grupo B", home:"Qatar", away:"Suiza", date:"Sab 13/06", time:"16:00" },
    { id:6, group:"Grupo C", home:"Brasil", away:"Marruecos", date:"Sab 13/06", time:"19:00" },
    { id:7, group:"Grupo C", home:"Haiti", away:"Escocia", date:"Sab 13/06", time:"22:00" },
    { id:8, group:"Grupo D", home:"Australia", away:"Turquia", date:"Sab 13/06", time:"01:00" },
    { id:9, group:"Grupo E", home:"Alemania", away:"Curazao", date:"Dom 14/06", time:"14:00" },
    { id:10, group:"Grupo E", home:"Costa de Marfil", away:"Ecuador", date:"Dom 14/06", time:"20:00" },
    { id:11, group:"Grupo F", home:"Paises Bajos", away:"Japon", date:"Dom 14/06", time:"17:00" },
    { id:12, group:"Grupo F", home:"Suecia", away:"Tunez", date:"Dom 14/06", time:"23:00" },
    { id:13, group:"Grupo G", home:"Belgica", away:"Egipto", date:"Lun 15/06", time:"16:00" },
    { id:14, group:"Grupo G", home:"Iran", away:"Nueva Zelanda", date:"Lun 15/06", time:"22:00" },
    { id:15, group:"Grupo H", home:"Espana", away:"Cabo Verde", date:"Lun 15/06", time:"13:00" },
    { id:16, group:"Grupo H", home:"Arabia Saudita", away:"Uruguay", date:"Lun 15/06", time:"19:00" },
    { id:17, group:"Grupo I", home:"Francia", away:"Senegal", date:"Mar 16/06", time:"16:00" },
    { id:18, group:"Grupo I", home:"Irak", away:"Noruega", date:"Mar 16/06", time:"19:00" },
    ...
    { id:21, group:"Grupo K", home:"Portugal", away:"R.D. Congo", date:"Mie 17/06", time:"14:00" },
    { id:22, group:"Grupo K", home:"Uzbekistan", away:"Colombia", date:"Mie 17/06", time:"23:00" },
    { id:23, group:"Grupo L", home:"Inglaterra", away:"Croacia", date:"Mie 17/06", time:"17:00" },
    { id:24, group:"Grupo L", home:"Ghana", away:"Panama", date:"Mie 17/06", time:"20:00" },
    { id:25, group:"Grupo A", home:"Chequia", away:"Sudafrica", date:"Jue 18/06", time:"13:00" },
    { id:26, group:"Grupo A", home:"Mexico", away:"Corea del Sur", date:"Jue 18/06", time:"22:00" },
    { id:27, group:"Grupo B", home:"Suiza", away:"Bosnia y Herzegovina", date:"Jue 18/06", time:"16:00" },
    { id:28, group:"Grupo B", home:"Canada", away:"Qatar", date:"Jue 18/06", time:"19:00" },
    { id:29, group:"Grupo C", home:"Escocia", away:"Marruecos", date:"Vie 19/06", time:"19:00" },
    { id:30, group:"Grupo C", home:"Brasil", away:"Haiti", date:"Vie 19/06", time:"21:30" },
    { id:31, group:"Grupo D", home:"Estados Unidos", away:"Australia", date:"Vie 19/06", time:"16:00" },
    { id:32, group:"Grupo D", home:"Turquia", away:"Paraguay", date:"Sab 20/06", time:"00:00" },
    { id:33, group:"Grupo D", home:"Turquia", away:"Estados Unidos", date:"Jue 25/06", time:"23:00" },
    { id:34, group:"Grupo D", home:"Paraguay", away:"Australia", date:"Jue 25/06", time:"23:00" },
    { id:35, group:"Grupo E", home:"Alemania", away:"Costa de Marfil", date:"Sab 20/06", time:"17:00" },
    { id:36, group:"Grupo E", home:"Ecuador", away:"Curazao", date:"Sab 20/06", time:"21:00" },
    { id:37, group:"Grupo F", home:"Paises Bajos", away:"Suecia", date:"Sab 20/06", time:"14:00" },
    { id:38, group:"Grupo F", home:"Japon", away:"Tunez", date:"Dom 21/06", time:"01:00" },
    { id:39, group:"Grupo G", home:"Belgica", away:"Iran", date:"Dom 21/06", time:"13:00" },
    { id:40, group:"Grupo G", home:"Nueva Zelanda", away:"Egipto", date:"Dom 21/06", time:"22:00" },
    { id:41, group:"Grupo H", home:"Espana", away:"Arabia Saudita", date:"Dom 21/06", time:"13:00" },
    { id:42, group:"Grupo H", home:"Uruguay", away:"Cabo Verde", date:"Dom 21/06", time:"19:00" },
    { id:43, group:"Grupo I", home:"Francia", away:"Irak", date:"Lun 22/06", time:"18:00" },
    { id:44, group:"Grupo I", home:"Noruega", away:"Senegal", date:"Lun 22/06", time:"21:00" },
    { id:45, group:"Grupo J", home:"Argentina", away:"Austria", date:"Lun 22/06", time:"14:00" },
    { id:46, group:"Grupo J", home:"Jordania", away:"Argelia", date:"Mar 23/06", time:"00:00" },
    { id:47, group:"Grupo K", home:"Portugal", away:"Uzbekistan", date:"Mar 23/06", time:"14:00" },
    { id:48, group:"Grupo K", home:"Colombia", away:"R.D. Congo", date:"Mar 23/06", time:"23:00" },
    { id:49, group:"Grupo L", home:"Inglaterra", away:"Ghana", date:"Mar 23/06", time:"17:00" },
    { id:50, group:"Grupo L", home:"Panama", away:"Croacia", date:"Mar 23/06", time:"20:00" },
    { id:51, group:"Grupo A", home:"Chequia", away:"Mexico", date:"Mie 24/06", time:"22:00" },
    { id:52, group:"Grupo A", home:"Sudafrica", away:"Corea del Sur", date:"Mie 24/06", time:"22:00" },
    { id:53, group:"Grupo B", home:"Suiza", away:"Canada", date:"Mie 24/06", time:"16:00" },
    { id:54, group:"Grupo B", home:"Bosnia y Herzegovina", away:"Qatar", date:"Mie 24/06", time:"16:00" },
    { id:55, group:"Grupo C", home:"Brasil", away:"Escocia", date:"Mie 24/06", time:"19:00" },
    { id:56, group:"Grupo C", home:"Marruecos", away:"Haiti", date:"Mie 24/06", time:"19:00" },
    { id:57, group:"Grupo E", home:"Curazao", away:"Costa de Marfil", date:"Jue 25/06", time:"17:00" },
    { id:58, group:"Grupo E", home:"Ecuador", away:"Alemania", date:"Jue 25/06", time:"17:00" },
    { id:59, group:"Grupo F", home:"Japon", away:"Suecia", date:"Jue 25/06", time:"20:00" },
    { id:60, group:"Grupo F", home:"Tunez", away:"Paises Bajos", date:"Jue 25/06", time:"20:00" },
    { id:61, group:"Grupo G", home:"Egipto", away:"Iran", date:"Sab 27/06", time:"00:00" },
    { id:62, group:"Grupo G", home:"Nueva Zelanda", away:"Belgica", date:"Sab 27/06", time:"00:00" },
    { id:63, group:"Grupo H", home:"Cabo Verde", away:"Arabia Saudita", date:"Vie 26/06", time:"21:00" },
    { id:64, group:"Grupo H", home:"Uruguay", away:"Espana", date:"Vie 26/06", time:"21:00" },
    { id:65, group:"Grupo I", home:"Noruega", away:"Francia", date:"Vie 26/06", time:"16:00" },
    { id:66, group:"Grupo I", home:"Senegal", away:"Irak", date:"Vie 26/06", time:"16:00" },
    { id:67, group:"Grupo J", home:"Argelia", away:"Austria", date:"Sab 27/06", time:"23:00" },
    { id:68, group:"Grupo J", home:"Jordania", away:"Argentina", date:"Sab 27/06", time:"23:00" },
    { id:69, group:"Grupo K", home:"Colombia", away:"Portugal", date:"Sab 27/06", time:"20:30" },
    { id:70, group:"Grupo K", home:"R.D. Congo", away:"Uzbekistan", date:"Sab 27/06", time:"20:30" },
    { id:71, group:"Grupo L", home:"Panama", away:"Inglaterra", date:"Sab 27/06", time:"18:00" },
    { id:72, group:"Grupo L", home:"Croacia", away:"Ghana", date:"Sab 27/06", time:"18:00" },
  ];
  grupos.forEach(p => m.push({ ...p, phase: "Fase de Grupos", result: null, hasResult: false }));
  const d16 = [
    {id:73,date:"Dom 28/06",time:"16:00"},{id:74,date:"Lun 29/06",time:"17:30"},
    {id:75,date:"Lun 29/06",time:"22:00"},{id:76,date:"Lun 29/06",time:"14:00"},
    {id:77,date:"Mar 30/06",time:"18:00"},{id:78,date:"Mar 30/06",time:"14:00"},
    {id:79,date:"Mar 30/06",time:"22:00"},{id:80,date:"Mie 01/07",time:"13:00"},
    {id:81,date:"Mie 01/07",time:"21:00"},{id:82,date:"Mie 01/07",time:"17:00"},
    {id:83,date:"Jue 02/07",time:"20:00"},{id:84,date:"Jue 02/07",time:"16:00"},
    {id:85,date:"Vie 03/07",time:"00:00"},{id:86,date:"Vie 03/07",time:"19:00"},
    {id:87,date:"Vie 03/07",time:"22:30"},{id:88,date:"Vie 03/07",time:"15:00"},
  ];
  ...
  const oct = [
    {id:89,date:"Sab 04/07",time:"14:00"},{id:90,date:"Sab 04/07",time:"18:00"},
    {id:91,date:"Dom 05/07",time:"17:00"},{id:92,date:"Dom 05/07",time:"21:00"},
    {id:93,date:"Lun 06/07",time:"16:00"},{id:94,date:"Lun 06/07",time:"21:00"},
    {id:95,date:"Mar 07/07",time:"13:00"},{id:96,date:"Mar 07/07",time:"17:00"},
  ];
  ...
  const cua = [
    {id:97,date:"Jue 09/07",time:"17:00"},{id:98,date:"Vie 10/07",time:"16:00"},
    {id:99,date:"Sab 11/07",time:"18:00"},{id:100,date:"Sab 11/07",time:"22:00"},
  ];
  ...
  m.push({id:102,group:"Semifinales",phase:"Semifinal",home:"Por definir",away:"Por definir",date:"Mie 15/07",time:"16:00",result:null,hasResult:false});
  m.push({id:103,group:"3er Puesto",phase:"3er y 4to Puesto",home:"Por definir",away:"Por definir",date:"Sab 18/07",time:"18:00",result:null,hasResult:false});
...
function calcScore(agent, matches) {
  ...
  matches.forEach(m => {
    ...
    if (!p) return;
    const { homeGoals: rh, awayGoals: ra, penaltyWinner: rpen } = m.result;
    const ph = parseInt(p.homeGoals), pa = parseInt(p.awayGoals);
    if (!isNaN(ph) && !isNaN(pa)) {
      if (ph === rh && pa === ra) {
        prode += POINT_VALUES.resultado_exacto;
        // bonus +1 si encima acerto ganador por penales
        if (rpen && p.penaltyWinner && p.penaltyWinner === rpen) prode += 1;
        return;
      }
      const isDraw = rh === ra;
      if (isDraw && rpen) {
        // fue a penales: ganador correcto = empate en 90min + penaltyWinner correcto
        if (ph === pa && p.penaltyWinner && p.penaltyWinner === rpen) prode += POINT_VALUES.ganador_correcto;
      } else {
        const rw = rh > ra ? "h" : "a";
...
.penalty-box{margin-top:10px;padding:10px 14px;background:rgba(212,160,23,.08);border:1px solid rgba(212,160,23,.3);border-radius:8px;display:flex;align-items:center;gap:12px;flex-wrap:wrap}
.penalty-lbl{font-family:'Barlow Condensed',sans-serif;font-size:.78rem;letter-spacing:1px;color:var(--dorado);text-transform:uppercase;font-weight:700}
...
function LoginScreen({ onLogin, loading }) {
  ...
  function submit() {
    ...
    if (mode === "login") {
      if (!email.includes("@")) { setError("Ingresa tu mail de KW"); return; }
  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        ...
        {mode === "register" && <div className="fg"><label className="fl">Nombre completo</label><input className="input" placeholder="Ej: Lucas Martinez" value={name} onChange={e => setName(e.target.value)} /></div>}
        <div className="fg">
        ...
        {mode === "login" && <div className="fg"><label className="fl">Contrasena (solo admin)</label><input className="input" type="password" placeholder="Solo si sos admin" value={pass} onChange={e => setPass(e.target.value)} onKeyDown={e => e.key === "Enter" && submit()} /></div>}
...
function RankingView({ agents, matches }) {
  ...
  return (
    <div>
      ...
      {filtered.length === 0 ? <div className="empty-state"><div className="empty-icon">&#x26BD;</div><div className="empty-txt">Sin agentes registrados</div></div> : (
...
function OfficinaView({ agents, matches }) {
  ...
  const icons = { "KW ON":"O","KW Leloir":"L","KW City":"C" };
  return (
    <div>
      <div className="card">
        ...
        {offices.map(off => {
          ...
          return (
            <div key={off} style={{background:"rgba(255,255,255,.03)",border:"1px solid "+colors[off]+"44",borderRadius:12,padding:18,marginBottom:14}}>
              ...
              {topAgent && <div style={{marginTop:12,fontSize:".83rem",color:"rgba(255,255,255,.45)"}}>Lider: <strong style={{color:colors[off]}}>{topAgent.name}</strong><span style={{marginLeft:8,color:"rgba(255,255,255,.3)"}}>{maxScore} pts</span></div>}
            </div>
          );
        })}
      </div>
...
function ProdeView({ agent, matches, overrides, onSave }) {
  ...
  return (
    <div>
      {saved && <div className="alert alert-ok">Predicciones guardadas!</div>}
      <div className="alert alert-warn">5 pts resultado exacto - 2 pts ganador correcto - 104 partidos</div>
      {phases.map(phase => {
        ...
        return (
          <div key={phase}>
            <div className="phase-header" style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
              <span>{phase}</span>
              <span style={{fontSize:".75rem",fontFamily:"Barlow Condensed",letterSpacing:1,color:open?"rgba(255,255,255,.4)":"#ff6b6b",fontWeight:700}}>{deadlineLabel}</span>
            </div>
            {!open && <div style={{background:"rgba(192,57,43,.12)",border:"1px solid rgba(192,57,43,.3)",borderRadius:8,padding:"8px 14px",marginBottom:10,fontSize:".8rem",color:"#ff9988",fontFamily:"Barlow Condensed",letterSpacing:1}}>Fase cerrada. No se pueden modificar pronosticos.</div>}
            {phaseMatches.map(m => {
              const isPending = m.home === "Por definir" || m.away === "Por definir";
              const hasResult = matchHasResult(m);
              const myPred = preds[m.id] || {};
              const showPenaltyInput = isKnockout && !hasResult && open && !isPending &&
                myPred.homeGoals !== undefined && myPred.homeGoals !== "" &&
                myPred.awayGoals !== undefined && myPred.awayGoals !== "" &&
                parseInt(myPred.homeGoals) === parseInt(myPred.awayGoals);
              return (
                <div key={m.id} style={{background:"rgba(255,255,255,.025)",border:"1px solid rgba(255,255,255,.06)",borderRadius:11,padding:14,marginBottom:10}}>
                  <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
                    ...
                    {hasResult ? (
                      <div style={{display:"flex",alignItems:"center",gap:14}}>
                        {myPred.homeGoals !== undefined && myPred.homeGoals !== "" ? (
                          <div style={{textAlign:"center"}}>
                            <div style={{fontSize:"1.1rem",fontFamily:"Bebas Neue",color:
                              (parseInt(myPred.homeGoals)===m.result.homeGoals && parseInt(myPred.awayGoals)===m.result.awayGoals) ? "#7dff9e" :
                              (m.result.penaltyWinner && parseInt(myPred.homeGoals)===parseInt(myPred.awayGoals) && myPred.penaltyWinner===m.result.penaltyWinner) ? "#ffb347" :
                              ((parseInt(myPred.homeGoals)>parseInt(myPred.awayGoals))===(m.result.homeGoals>m.result.awayGoals) && !m.result.penaltyWinner) ? "#ffb347" :
                              "rgba(255,255,255,.35)"
                            }}>
                              {myPred.homeGoals} - {myPred.awayGoals}
                              {myPred.penaltyWinner && <span style={{fontSize:".65rem",display:"block",color:"rgba(255,255,255,.4)"}}>pen: {myPred.penaltyWinner}</span>}
                            </div>
                            <div style={{fontSize:".55rem",color:"rgba(255,255,255,.28)",fontFamily:"Barlow Condensed"}}>TU PRODE</div>
                          </div>
                        ) : (
                          <div style={{textAlign:"center"}}>
                            <div style={{fontSize:"1.1rem",fontFamily:"Bebas Neue",color:"rgba(255,255,255,.25)"}}>--</div>
                            <div style={{fontSize:".55rem",color:"rgba(255,255,255,.25)",fontFamily:"Barlow Condensed"}}>SIN PRODE</div>
                          </div>
                        )}
                        <div className="score-disp">
                          {m.result.homeGoals} - {m.result.awayGoals}
                          {m.result.penaltyWinner && <div style={{fontSize:".55rem",color:"var(--dorado)",fontFamily:"Barlow Condensed"}}>pen: {m.result.penaltyWinner}</div>}
                          <div style={{fontSize:".58rem",color:"rgba(255,255,255,.28)",fontFamily:"Barlow Condensed"}}>FINAL</div>
                        </div>
                        {myPred.homeGoals !== undefined && myPred.homeGoals !== "" && (
                          <div style={{fontSize:"1.4rem"}}>
                            {parseInt(myPred.homeGoals)===m.result.homeGoals && parseInt(myPred.awayGoals)===m.result.awayGoals ? "&#x1F3AF;" :
                             (m.result.penaltyWinner && parseInt(myPred.homeGoals)===parseInt(myPred.awayGoals) && myPred.penaltyWinner===m.result.penaltyWinner) ? "&#x2705;" :
                             (!m.result.penaltyWinner && ((parseInt(myPred.homeGoals)>parseInt(myPred.awayGoals) && m.result.homeGoals>m.result.awayGoals) || (parseInt(myPred.homeGoals)<parseInt(myPred.awayGoals) && m.result.homeGoals<m.result.awayGoals) || (parseInt(myPred.homeGoals)===parseInt(myPred.awayGoals) && m.result.homeGoals===m.result.awayGoals))) ? "&#x2705;" : "&#x274C;"}
                          </div>
                        )}
                      </div>
                    ) : isPending ? (
                      ...
                      <div className="score-pair">
                        <input className="score-in" type="number" min="0" max="20" value={myPred.homeGoals??""} onChange={e=>setPred(m.id,"homeGoals",e.target.value)} placeholder="0"/>
                        <span style={{color:"rgba(255,255,255,.35)",fontFamily:"Bebas Neue"}}>-</span>
                        <input className="score-in" type="number" min="0" max="20" value={myPred.awayGoals??""} onChange={e=>setPred(m.id,"awayGoals",e.target.value)} placeholder="0"/>
                      </div>
                    )}
                  </div>
                  {showPenaltyInput && (
                    <div className="penalty-box">
                      <span className="penalty-lbl">Empate - quien gana por penales?</span>
                      <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:".88rem"}}>
                        <input type="radio" name={"penu"+m.id} value={m.home} checked={myPred.penaltyWinner===m.home} onChange={()=>setPred(m.id,"penaltyWinner",m.home)} style={{accentColor:"var(--dorado)"}}/>
                        {FLAGS[m.home]||""} {m.home}
                      </label>
                      <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:".88rem"}}>
                        <input type="radio" name={"penu"+m.id} value={m.away} checked={myPred.penaltyWinner===m.away} onChange={()=>setPred(m.id,"penaltyWinner",m.away)} style={{accentColor:"var(--dorado)"}}/>
                        {FLAGS[m.away]||""} {m.away}
                      </label>
                    </div>
                  )}
...
function MyStatsView({ agent, matches }) {
  ...
  return (
    <div>
      ...
      {logroItems.length > 0 ? (
        <div className="card">
          <div className="card-title">Tus logros</div>
          <div className="logros-grid">
            {logroItems.map(([key,count])=>(
              <div key={key} className="logro-item">
                <div className="logro-name">{LOGROS_LABELS[key]}</div>
                <div style={{textAlign:"right"}}><div style={{fontFamily:"Bebas Neue",fontSize:"1rem"}}>x{count}</div><div className="logro-pts">{count*POINT_VALUES[key]} pts</div></div>
              </div>
            ))}
          </div>
        </div>
      ) : <div className="empty-state"><div className="empty-icon">&#x1F3E1;</div><div className="empty-txt">El admin cargara tus logros</div></div>}
    </div>
  );
}
...
function ResultRow({ match, onSave, onClearResult }) {
  ...
  const showPenalty = isDraw && isKnockout;
  const home = homeTeam || match.home;
  const away = awayTeam || match.away;

  async function save() {
    await onSave(match.id, {
      ...match, home, away, hasResult: true,
      result: { homeGoals:parseInt(h)||0, awayGoals:parseInt(a)||0, penaltyWinner: showPenalty&&penaltyWinner ? penaltyWinner : "" }
    });
  }
  async function clear() { await onClearResult(match.id, { ...match, hasResult: false, result: null }); }

  return (
    <div style={{background:"rgba(255,255,255,.025)",border:"1px solid rgba(255,255,255,.06)",borderRadius:11,padding:14,marginBottom:10}}>
      <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
        ...
        {isPending ? (
          ...
          <div className="match-teams" style={{flex:1}}>
            <span>{FLAGS[match.home]||""}</span><span className="team-nm">{match.home}</span>
            <span className="vs">vs</span>
            <span className="team-nm">{match.away}</span><span>{FLAGS[match.away]||""}</span>
          </div>
        )}
        <div className="score-pair">
        ...
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          <button className="btn btn-primary btn-sm" onClick={save}>{matchHasResult(match)?"Actualizar":"Guardar"}</button>
          {matchHasResult(match) && <button className="btn btn-danger btn-sm" onClick={clear}>Borrar</button>}
        </div>
      </div>
      {showPenalty && (
        <div className="penalty-box">
          <span className="penalty-lbl">Ganador por penales:</span>
          <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:".88rem"}}>
            <input type="radio" name={"pen"+match.id} value={home} checked={penaltyWinner===home} onChange={()=>setPenaltyWinner(home)} style={{accentColor:"var(--dorado)"}}/>
            {FLAGS[home]||""} {home}
          </label>
          <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:".88rem"}}>
            <input type="radio" name={"pen"+match.id} value={away} checked={penaltyWinner===away} onChange={()=>setPenaltyWinner(away)} style={{accentColor:"var(--dorado)"}}/>
            {FLAGS[away]||""} {away}
          </label>
          {!penaltyWinner && <span style={{fontSize:".75rem",color:"#ff9988",fontFamily:"Barlow Condensed"}}>Selecciona el ganador antes de guardar</span>}
        </div>
      )}
      {matchHasResult(match) && match.result?.penaltyWinner && (
        <div style={{marginTop:8,fontSize:".78rem",color:"var(--dorado)",fontFamily:"Barlow Condensed",letterSpacing:1}}>
          Gano por penales: <strong>{match.result.penaltyWinner}</strong>
        </div>
      )}
    </div>
  );
...
function AdminView({ agents, matches, overrides, onSaveResult, onClearResult, onSaveLogros, onDeleteAgent, onSaveOverride }) {
  ...
  async function clearResult(matchId, matchData) { await onClearResult(matchId, matchData); flash("Resultado borrado - fase abierta para pronosticos"); }
  ...
  return (
    <div>
      <div className="card admin-card">
        <div className="card-title" style={{color:"#ff9988"}}>Panel de Administracion</div>
      ...
      {tab==="logros" && (
        <div className="card">
          ...
          <div className="fg">
            <label className="fl">Selecciona agente</label>
          ...
          {agent && (
            <>
              ...
              <div className="logros-grid">
                {DEV_KEYS.map(key=>(
                  <div key={key} className="logro-item">
                    <div><div className="logro-name">{LOGROS_LABELS[key]}</div><div className="logro-pts">{POINT_VALUES[key]} pts{ONCE_PER_YEAR.includes(key)?" 1x/anio":" c/u"}</div></div>
                    <div className="counter">
                      <button className="cbtn" onClick={()=>changeLogro(key,-1)}>-</button>
                      <div className="cval">{logros[key]||0}</div>
                      <button className="cbtn" onClick={()=>changeLogro(key,1)}>+</button>
      ...
      {tab==="agentes" && (
        <div className="card">
          ...
          <table className="table">
            <thead><tr><th>Nombre</th><th>Mail</th><th>Oficina</th><th>Predicciones</th><th>Puntos</th><th>Accion</th></tr></thead>
            <tbody>
              {[...agents].sort((a,b)=>a.name.localeCompare(b.name)).map(a=>{
                  ...
                  <tr key={a.email}>
                    ...
                    <td>
                      {confirmDelete===a.email ? (
                        ...
                        <button className="btn btn-red btn-sm" onClick={()=>setConfirmDelete(a.email)}>Eliminar</button>
                      )}
                    </td>
                  </tr>
                );
      ...
      {tab==="override" && (
        <div className="card" style={{borderColor:"rgba(255,165,0,.4)",background:"linear-gradient(135deg,rgba(255,165,0,.06),rgba(8,12,8,.9))"}}>
          <div className="card-title" style={{color:"#ffb347"}}>Habilitar carga de pronosticos</div>
          <div className="alert alert-warn" style={{marginBottom:16}}>
            Activa una fase para que los agentes puedan cargar pronosticos aunque la fecha limite ya paso.
          </div>
          {phases.map(phase => {
