...
function generateMatches() {
  ...
  const grupos = [
    ...
    { id:7, group:"Grupo C", home:"Haití", away:"Escocia", date:"Dom 14/06", time:"01:00" },
    { id:8, group:"Grupo D", home:"Australia", away:"Turquía", date:"Dom 14/06", time:"04:00" },
    // Domingo 14 Jun
    { id:9, group:"Grupo E", home:"Alemania", away:"Costa de Marfil", date:"Dom 14/06", time:"17:00" },
    { id:10, group:"Grupo E", home:"Ecuador", away:"Curazao", date:"Dom 14/06", time:"23:00" },
    { id:11, group:"Grupo F", home:"Países Bajos", away:"Japón", date:"Dom 14/06", time:"20:00" },
    { id:12, group:"Grupo F", home:"Túnez", away:"Suecia", date:"Lun 15/06", time:"02:00" },
    // Lunes 15 Jun
    { id:13, group:"Grupo G", home:"Bélgica", away:"Irán", date:"Lun 15/06", time:"19:00" },
    { id:14, group:"Grupo G", home:"Egipto", away:"Nueva Zelanda", date:"Mar 16/06", time:"01:00" },
    ...
    // Martes 16 Jun
    { id:17, group:"Grupo I", home:"Francia", away:"Senegal", date:"Mar 16/06", time:"19:00" },
    { id:18, group:"Grupo I", home:"Noruega", away:"Irak", date:"Mar 16/06", time:"22:00" },
    { id:19, group:"Grupo J", home:"Argentina", away:"Argelia", date:"Mié 17/06", time:"01:00" },
    { id:20, group:"Grupo J", home:"Austria", away:"Jordania", date:"Mié 17/06", time:"04:00" },
    // Miércoles 17 Jun
    { id:21, group:"Grupo K", home:"Portugal", away:"Colombia", date:"Mié 17/06", time:"17:00" },
    { id:22, group:"Grupo K", home:"Uzbekistán", away:"R.D. Congo", date:"Jue 18/06", time:"02:00" },
    { id:23, group:"Grupo L", home:"Inglaterra", away:"Croacia", date:"Mié 17/06", time:"20:00" },
    { id:24, group:"Grupo L", home:"Ghana", away:"Panamá", date:"Mié 17/06", time:"23:00" },
    // Jueves 18 Jun
    { id:25, group:"Grupo A", home:"Chequia", away:"Sudáfrica", date:"Jue 18/06", time:"16:00" },
    { id:26, group:"Grupo A", home:"México", away:"Corea del Sur", date:"Vie 19/06", time:"01:00" },
    { id:27, group:"Grupo B", home:"Suiza", away:"Bosnia y Herzegovina", date:"Jue 18/06", time:"19:00" },
    { id:28, group:"Grupo B", home:"Canadá", away:"Qatar", date:"Jue 18/06", time:"22:00" },
    // Viernes 19 Jun
    { id:29, group:"Grupo C", home:"Escocia", away:"Marruecos", date:"Vie 19/06", time:"22:00" },
    { id:30, group:"Grupo C", home:"Brasil", away:"Haití", date:"Sáb 20/06", time:"00:30" },
    { id:31, group:"Grupo D", home:"Estados Unidos", away:"Australia", date:"Vie 19/06", time:"19:00" },
    { id:32, group:"Grupo D", home:"Paraguay", away:"Turquía", date:"Sáb 20/06", time:"03:00" },
    // Sábado 20 Jun
    { id:33, group:"Grupo E", home:"Alemania", away:"Ecuador", date:"Sáb 20/06", time:"20:00" },
    { id:34, group:"Grupo E", home:"Costa de Marfil", away:"Curazao", date:"Dom 21/06", time:"00:00" },
    { id:35, group:"Grupo F", home:"Japón", away:"Túnez", date:"Dom 21/06", time:"04:00" },
    { id:36, group:"Grupo F", home:"Países Bajos", away:"Suecia", date:"Sáb 20/06", time:"17:00" },
    // Domingo 21 Jun
    { id:37, group:"Grupo G", home:"Irán", away:"Nueva Zelanda", date:"Lun 22/06", time:"01:00" },
    { id:38, group:"Grupo G", home:"Bélgica", away:"Egipto", date:"Dom 21/06", time:"19:00" },
    { id:39, group:"Grupo H", home:"Uruguay", away:"Cabo Verde", date:"Dom 21/06", time:"22:00" },
    { id:40, group:"Grupo H", home:"España", away:"Arabia Saudita", date:"Dom 21/06", time:"16:00" },
    // Lunes 22 Jun
    { id:41, group:"Grupo I", home:"Senegal", away:"Noruega", date:"Mar 23/06", time:"00:00" },
    { id:42, group:"Grupo I", home:"Francia", away:"Irak", date:"Lun 22/06", time:"21:00" },
    { id:43, group:"Grupo J", home:"Argelia", away:"Austria", date:"Lun 22/06", time:"17:00" },
    { id:44, group:"Grupo J", home:"Argentina", away:"Jordania", date:"Mar 23/06", time:"03:00" },
    // Martes 23 Jun
    { id:45, group:"Grupo K", home:"Colombia", away:"Uzbekistán", date:"Mar 23/06", time:"17:00" },
    { id:46, group:"Grupo K", home:"Portugal", away:"R.D. Congo", date:"Mié 24/06", time:"02:00" },
    { id:47, group:"Grupo L", home:"Croacia", away:"Ghana", date:"Mar 23/06", time:"20:00" },
    { id:48, group:"Grupo L", home:"Inglaterra", away:"Panamá", date:"Mar 23/06", time:"23:00" },
    // Miércoles 24 Jun
    { id:49, group:"Grupo A", home:"Chequia", away:"México", date:"Jue 25/06", time:"01:00" },
    { id:50, group:"Grupo A", home:"Sudáfrica", away:"Corea del Sur", date:"Jue 25/06", time:"01:00" },
    { id:51, group:"Grupo B", home:"Suiza", away:"Canadá", date:"Mié 24/06", time:"19:00" },
    { id:52, group:"Grupo B", home:"Bosnia y Herzegovina", away:"Qatar", date:"Mié 24/06", time:"19:00" },
    { id:53, group:"Grupo C", home:"Escocia", away:"Brasil", date:"Mié 24/06", time:"22:00" },
    { id:54, group:"Grupo C", home:"Marruecos", away:"Haití", date:"Mié 24/06", time:"22:00" },
    // Jueves 25 Jun
    { id:55, group:"Grupo E", home:"Alemania", away:"Curazao", date:"Jue 25/06", time:"20:00" },
    { id:56, group:"Grupo E", home:"Costa de Marfil", away:"Ecuador", date:"Jue 25/06", time:"23:00" },
    { id:57, group:"Grupo F", home:"Japón", away:"Suecia", date:"Jue 25/06", time:"23:00" },
    { id:58, group:"Grupo F", home:"Países Bajos", away:"Túnez", date:"Jue 25/06", time:"23:00" },
    // Viernes 26 Jun
    { id:59, group:"Grupo G", home:"Bélgica", away:"Nueva Zelanda", date:"Sáb 27/06", time:"03:00" },
    { id:60, group:"Grupo G", home:"Irán", away:"Egipto", date:"Sáb 27/06", time:"03:00" },
    { id:61, group:"Grupo H", home:"España", away:"Uruguay", date:"Sáb 27/06", time:"00:00" },
    { id:62, group:"Grupo H", home:"Arabia Saudita", away:"Cabo Verde", date:"Vie 26/06", time:"21:00" },
    // Sábado 27 Jun
    { id:63, group:"Grupo D", home:"Estados Unidos", away:"Turquía", date:"Vie 26/06", time:"02:00" },
    { id:64, group:"Grupo D", home:"Paraguay", away:"Australia", date:"Vie 26/06", time:"02:00" },
    { id:65, group:"Grupo I", home:"Francia", away:"Noruega", date:"Vie 26/06", time:"19:00" },
    { id:66, group:"Grupo I", home:"Senegal", away:"Irak", date:"Vie 26/06", time:"19:00" },
    { id:67, group:"Grupo J", home:"Argentina", away:"Austria", date:"Sáb 27/06", time:"23:00" },
    { id:68, group:"Grupo J", home:"Argelia", away:"Jordania", date:"Sáb 27/06", time:"23:00" },
                      ...
                      {myPred && myPred.homeGoals!==undefined && myPred.homeGoals!=="" && (
                        <div style={{fontSize:"1.4rem"}}>
                          {parseInt(myPred.homeGoals)===m.result.homeGoals && parseInt(myPred.awayGoals)===m.result.awayGoals ? "🎯" :
                           (parseInt(myPred.homeGoals)>parseInt(myPred.awayGoals) && m.result.homeGoals>m.result.awayGoals) ||
                           (parseInt(myPred.homeGoals)<parseInt(myPred.awayGoals) && m.result.homeGoals<m.result.awayGoals) ||
                           (parseInt(myPred.homeGoals)===parseInt(myPred.awayGoals) && m.result.homeGoals===m.result.awayGoals) ? "✅" : "❌"}
                        </div>
                      )}
