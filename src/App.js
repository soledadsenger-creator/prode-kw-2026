...
function generateMatches() {
  ...
  const grupos = [
    ...
    { id:12, group:"Grupo F", home:"Suecia", away:"Túnez", date:"Dom 14/06", time:"23:00" },
    { id:13, group:"Grupo G", home:"Bélgica", away:"Egipto", date:"Lun 15/06", time:"16:00" },
    { id:14, group:"Grupo G", home:"Irán", away:"Nueva Zelanda", date:"Lun 15/06", time:"22:00" },
    { id:15, group:"Grupo H", home:"España", away:"Cabo Verde", date:"Lun 15/06", time:"13:00" },
    ...
    { id:21, group:"Grupo K", home:"Portugal", away:"R.D. Congo", date:"Mié 17/06", time:"14:00" },
    { id:22, group:"Grupo K", home:"Uzbekistán", away:"Colombia", date:"Mié 17/06", time:"23:00" },
    ...
    { id:30, group:"Grupo C", home:"Brasil", away:"Haití", date:"Vie 19/06", time:"21:30" },
    { id:31, group:"Grupo D", home:"Estados Unidos", away:"Australia", date:"Vie 19/06", time:"16:00" },
    { id:32, group:"Grupo D", home:"Turquía", away:"Paraguay", date:"Sáb 20/06", time:"00:00" },
    { id:33, group:"Grupo D", home:"Turquía", away:"Estados Unidos", date:"Jue 25/06", time:"23:00" },
    { id:34, group:"Grupo D", home:"Paraguay", away:"Australia", date:"Jue 25/06", time:"23:00" },
    { id:35, group:"Grupo E", home:"Alemania", away:"Costa de Marfil", date:"Sáb 20/06", time:"17:00" },
    { id:36, group:"Grupo E", home:"Ecuador", away:"Curazao", date:"Sáb 20/06", time:"21:00" },
    { id:37, group:"Grupo F", home:"Países Bajos", away:"Suecia", date:"Sáb 20/06", time:"14:00" },
    { id:38, group:"Grupo F", home:"Japón", away:"Túnez", date:"Dom 21/06", time:"01:00" },
    { id:39, group:"Grupo G", home:"Bélgica", away:"Irán", date:"Dom 21/06", time:"13:00" },
    { id:40, group:"Grupo G", home:"Nueva Zelanda", away:"Egipto", date:"Dom 21/06", time:"22:00" },
    { id:41, group:"Grupo H", home:"España", away:"Arabia Saudita", date:"Dom 21/06", time:"13:00" },
    ...
    { id:47, group:"Grupo K", home:"Portugal", away:"Uzbekistán", date:"Mar 23/06", time:"14:00" },
    ...
    { id:50, group:"Grupo L", home:"Panamá", away:"Croacia", date:"Mar 23/06", time:"20:00" },
    { id:51, group:"Grupo A", home:"Chequia", away:"México", date:"Mié 24/06", time:"22:00" },
    { id:52, group:"Grupo A", home:"Sudáfrica", away:"Corea del Sur", date:"Mié 24/06", time:"22:00" },
    { id:53, group:"Grupo B", home:"Suiza", away:"Canadá", date:"Mié 24/06", time:"16:00" },
    { id:54, group:"Grupo B", home:"Bosnia y Herzegovina", away:"Qatar", date:"Mié 24/06", time:"16:00" },
    { id:55, group:"Grupo C", home:"Brasil", away:"Escocia", date:"Mié 24/06", time:"19:00" },
    { id:56, group:"Grupo C", home:"Marruecos", away:"Haití", date:"Mié 24/06", time:"19:00" },
    ...
    { id:59, group:"Grupo F", home:"Japón", away:"Suecia", date:"Jue 25/06", time:"20:00" },
    { id:60, group:"Grupo F", home:"Túnez", away:"Países Bajos", date:"Jue 25/06", time:"20:00" },
    { id:61, group:"Grupo G", home:"Egipto", away:"Irán", date:"Sáb 27/06", time:"00:00" },
    { id:62, group:"Grupo G", home:"Nueva Zelanda", away:"Bélgica", date:"Sáb 27/06", time:"00:00" },
    { id:63, group:"Grupo H", home:"Cabo Verde", away:"Arabia Saudita", date:"Vie 26/06", time:"21:00" },
    { id:64, group:"Grupo H", home:"Uruguay", away:"España", date:"Vie 26/06", time:"21:00" },
    ...
    { id:67, group:"Grupo J", home:"Argelia", away:"Austria", date:"Sáb 27/06", time:"23:00" },
    { id:68, group:"Grupo J", home:"Jordania", away:"Argentina", date:"Sáb 27/06", time:"23:00" },
    { id:69, group:"Grupo K", home:"Colombia", away:"Portugal", date:"Sáb 27/06", time:"20:30" },
    { id:70, group:"Grupo K", home:"R.D. Congo", away:"Uzbekistán", date:"Sáb 27/06", time:"20:30" },
